...
# Plot the sample chart with the training and test data and the fitted model
# For high-dimensional data, we focus on coefficients
plt.figure(figsize=(10, 6))
...
# Ridge regression coefficients show the impact of regularization. Lower MSE and higher R^2 indicate a good fit.
# The regularization parameter (alpha) can be adjusted to control the amount of shrinkage.